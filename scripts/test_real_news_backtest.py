...
# Real news events with approximate timestamps
AAPL_NEWS = [
...
TSLA_NEWS = [
    ...
    {"date": "2025-04-23T10:00:00", "headline": "Elon Musk says he will reduce DOGE role to focus on Tesla"},
]
...
META_NEWS = [
    ...
    {"date": "2025-02-14T10:00:00", "headline": "Meta announces massive AI spending increase, stock drops on cost fears"},
